...
void Utilisateur_Modifier(GtkButton *button, gpointer user_data)
{
   gchar *titre;
  gchar *auteur;
  gchar *maison;
...
void admin_modifier_utilisateur(GtkWidget *window,int idLivre)
{
...
g_signal_connect ( button_submit, "clicked",Utilisateur_Modifier, window);
